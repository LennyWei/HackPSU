...
def gestures():
    ...
    return render_template('gestures.html', gestures_list=gestures_list)
    ...
    while True:
        ...
        if results.multi_hand_landmarks:
            ...
            if model is not None and label_map:
                ...
                bindings = load_bindings()
                if current_gesture_count == GESTURE_HOLD_COUNT  or current_gesture_count >= 6 and predicted_label in bindings:
